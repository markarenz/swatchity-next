...
import handler from '../../../../src/pages/api/reply/setLikeReply';
import mockUserData from '../../../__fixtures__/mockUserMeta';
import mockSwatch from '../../../__fixtures__/mockSwatch';
import { mockReply, mockReplyExt } from '../../../__fixtures__/mockReply';
...
describe('/api/swatch/setLikeReply API endpoint', () => {
  ...
  it('handles like add when like does not exist', async () => {
    ...
    prismaMock.replyLike.count.mockResolvedValue(0);
