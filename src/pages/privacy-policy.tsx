...
const PrivacyPolicy: NextPage = () => {
  const pageMeta: PageMeta = {
    ...
    metadesc: 'At Swatchity, privacy is important to us as well as to you.',
  };

  return (
    <Layout pageMeta={pageMeta}>
      <div id="layout-page">
        <div className="contained pt-2 pb-6">
          <h1 className="pb-1">Swatchity.com Privacy Policy</h1>
          <p>
            Swatchity operates the https://www.swatchity.com website, which provides the SERVICE.
          </p>
          ...
          <p>
            ...
            with anyone except as described in this Privacy Policy. Our Privacy Policy was created
            with the help of the Privacy Policy Template Generator.
          </p>

          <p>
            The terms used in this Privacy Policy have the same meanings as in our Terms and
            Conditions, which is accessible at https://www.swatchity.com, unless otherwise defined
            in this Privacy Policy.
          </p>

          <h2 className="pt-2">Information Collection and Use</h2>
          ...
          <p>
            ...
            Service-related services; or To assist us in analyzing how our Service is used. We want
            to inform our Service users that these third parties have access to your Personal
            Information. The reason is to perform the tasks assigned to them on our behalf. However,
            they are obligated not to disclose or use the information for any other purpose.
          </p>

          <h2 className="pt-2">Security</h2>
          ...
          <h2 className="pt-2">Links to Other Sites</h2>
          ...
          <h2 className="pt-2">Changes to This Privacy Policy</h2>
          ...
          <h2 className="pt-2">Contact Us</h2>
